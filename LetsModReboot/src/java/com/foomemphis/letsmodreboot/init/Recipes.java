...
public class Recipes
{
	public static void init()
	{
		...
		// danach wofür steht der zugewiesene Buchstabe
		// 's' Zuweisung das in DIESEM (!!) Rezept "s" für einen Vanilla Stick steht
		// Leerzeichen steht für ein leeres Feld im Craftingfenster
		...
		// zuerst Output
		// danach Einträge für die möglichen Inputs ( hier ergeben 2 MapleLeaf's einen Flaggen Block )
		...
		// hier würde also jedes Item das im OreDictionary unter Stick registriert ist dazu verwendet werden können unser MapleLeaf zu craften.
		...
		// statt ein ItemStack Rezept zu verwenden kann man so ein OreDictionary Rezept verwenden
		// hier würde also ein Item das im OreDictionary unter Stick registriert ist zusammen mit einem MapleLeaf dazu verwendet werden kann einen FlaggenBlock zu craften.
	}
}
